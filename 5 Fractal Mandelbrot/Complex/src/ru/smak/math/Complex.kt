...
// Инфиксную функцию можно вызывать так: "c pow 2". А стандартно так: "c.pow(2)"
...
class Complex(var re: Double, var im: Double) {
     ...
     */
    infix fun pow(p: Int): Complex {  // Инфиксную функцию можно вызывать так: "c pow 2". А стандартно так: "c.pow(2)"
        val res =  Complex(1.0)
