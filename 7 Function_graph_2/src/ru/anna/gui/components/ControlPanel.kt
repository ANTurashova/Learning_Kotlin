...
class ControlPanel : JPanel(){
    ...
    init{
        ...
        // sm - спинэр модул
        smXMin = SpinnerNumberModel(-10.0, -100.0, 9.9, 0.1)  // скролл
        smXMax = SpinnerNumberModel(10.0, -9.9, 100.0, 0.1)  // скролл
        smYMin = SpinnerNumberModel(-10.0, -100.0, 9.9, 0.1)  // скролл
        smYMax = SpinnerNumberModel(10.0, -9.9, 100.0, 0.1)  // скролл
